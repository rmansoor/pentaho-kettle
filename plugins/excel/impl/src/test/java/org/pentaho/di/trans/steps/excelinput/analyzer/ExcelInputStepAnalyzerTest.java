...
import org.pentaho.di.trans.steps.exceloutput.analyzer.ExcelOutputAnalyzer;
...
public class ExcelInputStepAnalyzerTest {
  ...
  private ExcelInputAnalyzer analyzer;
  ...
  public void setUp() throws Exception {
    ...
    analyzer = spy( new ExcelInputAnalyzer() );
  ...
  public void testGetSupportedSteps() {
    ExcelInputAnalyzer analyzer = new ExcelInputAnalyzer();
