 ...
 */
@Step( id = "ExcelInput", image = "ui/images/XLI.svg", i18nPackageName = "org.pentaho.di.trans.steps.excelinput",
        documentationUrl = "Products/Microsoft_Excel_Input", name = "ExcelInput.name",
        description = "ExcelInput.TypeLongDesc.ExcelInput", categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Input" )
