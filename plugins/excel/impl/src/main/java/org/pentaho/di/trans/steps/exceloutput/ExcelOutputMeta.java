 ...
 * @since on 6-sep-2006
 */
@Step( id = "ExcelOutput", image = "ui/images/XLO.svg", i18nPackageName = "org.pentaho.di.trans.steps.exceloutput",
        documentationUrl = "Products/Microsoft_Excel_Output", name = "ExcelOutput.name",
        description = "ExcelOutput.TypeLongDesc.ExcelOutput", categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Output" )
