...
package org.pentaho.di.trans.steps.excelinput.analyzer;
...
@LifecyclePlugin( id = "ExcelInputAnalyzerPlugin", name = "ExcelInputAnalyzerPlugin" )
public class ExcelInputAnalyzerPluginLifecycleListener implements LifecycleListener {

  @Override
  public void onStart( final LifeEventHandler lifeEventHandler ) throws LifecycleException {

    // instantiate a new analyzer
    final ExcelInputAnalyzer analyzer = new ExcelInputAnalyzer();
    // construct the external resource consumer for the files that it reads from
    final IStepExternalResourceConsumer consumer = new ExcelInputExternalResourceConsumer();
