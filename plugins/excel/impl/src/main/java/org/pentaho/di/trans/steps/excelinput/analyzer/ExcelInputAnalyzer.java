 ...
 * metaverse entities
 */
public class ExcelInputAnalyzer extends ExternalResourceStepAnalyzer<ExcelInputMeta> {
  private Logger log = LoggerFactory.getLogger( ExcelInputAnalyzer.class );
  ...
  @Override
  public Set<StepField> getUsedFields(ExcelInputMeta meta) {
