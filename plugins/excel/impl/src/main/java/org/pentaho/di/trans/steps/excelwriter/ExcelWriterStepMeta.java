...
@Step( id = "ExcelWriter", image = "ui/images/XWS.svg", i18nPackageName = "org.pentaho.di.trans.steps.excelwriter",
        documentationUrl = "Products/Microsoft_Excel_Writer", name = "ExcelWriter.name",
        description = "ExcelOutput.TypeLongDesc.ExcelWriter", categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Output" )
