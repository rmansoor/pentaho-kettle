 ...
 */
public class ExcelOutputAnalyzer extends ExternalResourceStepAnalyzer<ExcelOutputMeta> {

  private Logger log = LoggerFactory.getLogger( ExcelOutputAnalyzer.class );
  ...
  @Override
  public Set<StepField> getUsedFields(ExcelOutputMeta meta) {
    return null;
  }
  ...
  @Override protected IClonableStepAnalyzer newInstance() {
    return new ExcelOutputAnalyzer();
  }
