...
package org.pentaho.di.trans.steps.exceloutput.analyzer;
...
@LifecyclePlugin( id = "ExcelOutputAnalyzerPlugin", name = "ExcelOutputAnalyzerPlugin" )
public class ExcelOutputAnalyzerPluginLifecycleListener implements LifecycleListener {

  @Override
  public void onStart( final LifeEventHandler lifeEventHandler ) throws LifecycleException {

    // instantiate a new analyzer
    final ExcelOutputAnalyzer analyzer = new ExcelOutputAnalyzer();
    // construct the external resource consumer for the files that it reads from
    final IStepExternalResourceConsumer consumer = new ExcelOutputExternalResourceConsumer();
